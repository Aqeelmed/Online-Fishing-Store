...
<div>
    ...
    <section class="slider_section ">
        <div class="slider_bg_box">
            <img src="{{asset('images')}}/Can-Turtles.jpg" alt="">
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7 col-lg-6 ">
                                <div class="detail-box">
                                    ...
                                    <p>
                                        A flash sale is one that offers some sort of savings but only for a short time.
                                         A good flash sale creates urgency, hype, and a spike in sales. 
                                    </p>
                                    <div class="btn-box">
                                        <a href="{{url('products')}}" class="btn1">
                                            Shop Now
                        ...
                        <div class="row">
                            <div class="col-md-7 col-lg-6 ">
                                <div class="detail-box">
                                    ...
                                    <p>
                                        A sales promotion is a tried and true way to ramp up your sales,
                                         acquire new customers, and take advantage of seasonal opportunities. 
                                        Sales promotions are a short-term marketing tactic to create urgency and increase sales.
                                    </p>
                                    <div class="btn-box">
                                        <a href="{{url('products')}}" class="btn1">
                                            Shop Now
            ...
            <div class="col-md-4">
                <div class="box ">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Shipment will get transported to him anywhere between 24 to 72 hours🛺.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="box ">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Free shipping is for our long-term customers who love to purchased goods from our store.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="box ">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                        our responsibilty to deliver product to customer in best quality.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="box">
            <div class="arrival_bg_box">
                <img src="{{asset('images')}}/fish_cover.png" alt="">
            </div>
            <div class="row">
                <div class="col-md-6 ml-auto">
                    ...
                    <p style="margin-top: 20px;margin-bottom: 30px; color:antiquewhite">
                        New arrival emails are product promotion emails that highlight a new product and inform the reader about its details. 
                        You can use it to announce a new product release, a limited-edition launch, or a new collection release.
                    </p>
                </div>    
            </div>
        </div>
                ...
                <div class="carousel-item">
                    <div class="box col-lg-10 mx-auto">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                My Pet Fish has always been one of my favorites, as I like reading about this boy who is inspired to keep fish from his friend and neighbor
                                 and then eventually goes into the hobby himself.   
